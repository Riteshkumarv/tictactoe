...
private boolean flag;
    public void cheakOorXisWinOrNot(){
        if(!flag)reset();
    }
    ...
    public void update(String XandO){
        if(XandO.equals("O")){
            counto++;
            jLabel3.setText(String.valueOf(counto));
        }else{
            countx++;
            jLabel4.setText(String.valueOf(countx));
        }
    }
    ...
    public void cheakwin(){
        ...
        if(b1.equals(b2) && b2.equals(b3) && !b1.equals("")){
            ...
            winColor(jButton4,jButton3,jButton2);
            
            update(turn);
            
        }else if(b4.equals(b5) && b4.equals(b6) && !b5.equals("")){
            JOptionPane.showMessageDialog(this, "player "+turn+" Wins", "TIC TAC TOE", JOptionPane.INFORMATION_MESSAGE);
            
            winColor(jButton7,jButton6,jButton5);
            
            update(turn);
        }else if(b7.equals(b8) && b8.equals(b9) && !b9.equals("")){
            JOptionPane.showMessageDialog(this, "player "+turn+" Wins", "TIC TAC TOE", JOptionPane.INFORMATION_MESSAGE);
            
            winColor(jButton10,jButton9,jButton8);
            
            update(turn);
        }else if(b1.equals(b4) && b4.equals(b7) && !b1.equals("")){
            JOptionPane.showMessageDialog(this, "player "+turn+" Wins", "TIC TAC TOE", JOptionPane.INFORMATION_MESSAGE);
            
            winColor(jButton4,jButton7,jButton10);
            
            update(turn);
        }else if(b2.equals(b5) && b5.equals(b8) && !b2.equals("")){
            JOptionPane.showMessageDialog(this, "player "+turn+" Wins", "TIC TAC TOE", JOptionPane.INFORMATION_MESSAGE);
            
            winColor(jButton6,jButton3,jButton9);
            
            update(turn);
        }else if(b3.equals(b6) && b6.equals(b9) && !b3.equals("")){
            JOptionPane.showMessageDialog(this, "player "+turn+" Wins", "TIC TAC TOE", JOptionPane.INFORMATION_MESSAGE);
            
            winColor(jButton5,jButton8,jButton2);
            
            update(turn);
        }else if(b1.equals(b5) && b5.equals(b9) && !b1.equals("")){
            JOptionPane.showMessageDialog(this, "player "+turn+" Wins","TIC TAC TOE", JOptionPane.INFORMATION_MESSAGE);
            
            winColor(jButton4,jButton6,jButton8);
            
            update(turn);
        }else if(b7.equals(b5) && b5.equals(b3) && !b3.equals("")){
            JOptionPane.showMessageDialog(this, "player "+turn+" Wins", "TIC TAC TOE", JOptionPane.INFORMATION_MESSAGE);
            
            winColor(jButton10,jButton6,jButton2);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        invokedButton(jButton2);
        
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        invokedButton(jButton5);
        
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
        invokedButton(jButton8);
        
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        JFrame frame = new JFrame("Exit");
        if(JOptionPane.showConfirmDialog(frame,"conform if you want to Exit","Tic Tac Toe",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION){
            System.exit(0);
        }
